...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Utilisateur.afsbreljked'
        db.add_column(u'login_utilisateur', 'afsbreljked',
                      self.gf('django.db.models.fields.CharField')(default='       ', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Utilisateur.afsbreljked'
        db.delete_column(u'login_utilisateur', 'afsbreljked')
    ...
    models = {
        ...
        u'login.utilisateur': {
            ...
            'afsbreljked': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
